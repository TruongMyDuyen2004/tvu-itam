...
router.post('/qr/scan-log', ctrl.logScan);
router.put('/qr/scan-update', requireRole('superadmin', 'admin'), ctrl.scanUpdate);
router.get('/qr/scan-logs', requireRole('superadmin', 'admin'), ctrl.getScanLogs);
